...
final class Day03Tests: XCTestCase {
    ...
    func test_part2_sumGearRatios_sampleData() {
        XCTAssertEqual(467_835, sumGearRatios(sampleData))
    }
    
    func test_part2_sumGearRatios_puzzleInput() {
        XCTAssertEqual(80_703_636, sumGearRatios(puzzleInput))
    }
    ...
    // Two numbers are not part numbers - they are not adjacent to a symbol
    // 114 and 58
    // sum should be 4361
    // Pluck out 467, 35, 633, 617, 592, 755, 664, 598
    let sampleData = """
    467..114..
    ...*......
    ..35..633.
