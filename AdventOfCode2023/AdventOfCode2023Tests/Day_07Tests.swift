...
final class Day07Tests: XCTestCase {
    func test_part1_sampleData() {
        XCTAssertEqual(6440, day07_part1(sampleData))
    }
    ...
    func test_part1_findCardType() {
        ...
        XCTAssertEqual(.fullHouse, CamelCardHand(hand: "23332", bid: 0).type)
        XCTAssertEqual(.threeOfAKind, CamelCardHand(hand: "TTT98", bid: 0).type)
    ...
    func test_part1_cardSorting() {
        let sortedCards = extractCamelCardHands(sampleData).sorted()
        XCTAssertEqual(sortedCards[0].hand, "32T3K")
        XCTAssertEqual(sortedCards[1].hand, "KTJJT")
        XCTAssertEqual(sortedCards[2].hand, "KK677")
        XCTAssertEqual(sortedCards[3].hand, "T55J5")
        XCTAssertEqual(sortedCards[4].hand, "QQQJA")
    }
