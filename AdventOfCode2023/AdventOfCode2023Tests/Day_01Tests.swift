...
final class Day01Tests: XCTestCase {
    ...
    func test_partI_extractCalibrationValue_singleRow_shouldExtractNumber() {
        XCTAssertEqual(12, extractCalibrationValuev1("1abc2"))
        XCTAssertEqual(38, extractCalibrationValuev1("pqr3stu8vwx"))
        XCTAssertEqual(15, extractCalibrationValuev1("a1b2c3d4e5f"))
        XCTAssertEqual(77, extractCalibrationValuev1("treb7uchet"))
    }
    
    func test_partI_extractCalibrationValue_multipleRows_shouldExtractSumOfNumbers() {
        let sampleData = """
            1abc2
            pqr3stu8vwx
            a1b2c3d4e5f
            treb7uchet
            """
        XCTAssertEqual(142, extractCalibrationValuev1(sampleData))
    }
    
    func test_partI_extractCalibrationValue_puzzleInput_shouldExtractSumOfNumbers() {
        XCTAssertEqual(54_697, extractCalibrationValuev1(puzzleInput))
    }
    
    // MARK: - Part II
    
    func test_partII_digitForNumber_shouldConvertToDigit() {
        XCTAssertEqual(1, Digit.intValue(for: Character("1")))
        XCTAssertEqual(2, Digit.intValue(for: Character("2")))
        XCTAssertEqual(3, Digit.intValue(for: Character("3")))
        XCTAssertEqual(4, Digit.intValue(for: Character("4")))
        XCTAssertEqual(5, Digit.intValue(for: Character("5")))
        XCTAssertEqual(6, Digit.intValue(for: Character("6")))
        XCTAssertEqual(7, Digit.intValue(for: Character("7")))
        XCTAssertEqual(8, Digit.intValue(for: Character("8")))
        XCTAssertEqual(9, Digit.intValue(for: Character("9")))
    }
    
    func test_partII_extractCalibrationValue_singleRow_shouldExtractNumber() {
        XCTAssertEqual(29, extractCalibrationValuev2("two1nine"))
        XCTAssertEqual(83, extractCalibrationValuev2("eightwothree"))
        XCTAssertEqual(13, extractCalibrationValuev2("abcone2threexyz"))
        XCTAssertEqual(24, extractCalibrationValuev2("xtwone3four"))
        XCTAssertEqual(42, extractCalibrationValuev2("4nineeightseven2"))
        XCTAssertEqual(14, extractCalibrationValuev2("zoneight234"))
        XCTAssertEqual(76, extractCalibrationValuev2("7pqrstsixteen"))
        
        // Edge case - replace first only
        XCTAssertEqual(82, extractCalibrationValuev2("eighteightwo"))
        
        // Original test cases
        XCTAssertEqual(12, extractCalibrationValuev2("1abc2"))
        XCTAssertEqual(38, extractCalibrationValuev2("pqr3stu8vwx"))
        XCTAssertEqual(15, extractCalibrationValuev2("a1b2c3d4e5f"))
        XCTAssertEqual(77, extractCalibrationValuev2("treb7uchet"))
        
        // More test cases
        XCTAssertEqual(11, extractCalibrationValuev2("zlmlk1"))
        XCTAssertEqual(71, extractCalibrationValuev2("vqjvxtc79mvdnktdsxcqc1sevenone"))
        XCTAssertEqual(76, extractCalibrationValuev2("vsskdclbtmjmvrseven6"))
        XCTAssertEqual(88, extractCalibrationValuev2("8jkfncbeight7seven8"))
        XCTAssertEqual(68, extractCalibrationValuev2("six8dbfrsxp"))
        XCTAssertEqual(26, extractCalibrationValuev2("2zpcbjdxcjfone68six"))
        XCTAssertEqual(58, extractCalibrationValuev2("zqmzgfivethreefdnlhpeight8798"))
        
        
        XCTAssertEqual(56, extractCalibrationValuev2("fivenineone6"))
        XCTAssertEqual(69, extractCalibrationValuev2("6sixzvdsprdqlftwonine"))
        XCTAssertEqual(28, extractCalibrationValuev2("lqztrmztwo8dg"))
        
        XCTAssertEqual(33, extractCalibrationValuev2("33rgcjxfsfqsvxxbxcnrjfndrrfmrtk"))
        XCTAssertEqual(38, extractCalibrationValuev2("3627837xhhb8"))
        XCTAssertEqual(44, extractCalibrationValuev2("bmjhkkn4pgf"))
        XCTAssertEqual(23, extractCalibrationValuev2("qkrsvjclp23"))
        XCTAssertEqual(56, extractCalibrationValuev2("5fourzllbmcgkxsevengkrzkpvcmvgtxlrv6"))
        XCTAssertEqual(53, extractCalibrationValuev2("fivetczxxvjrrqfive1sevennvj6one3"))
    }
    
    func test_partII_extractCalibrationValue_puzzleInput_shouldExtractSumOfNumbers() {
        XCTAssertEqual(54_885, extractCalibrationValuev2(puzzleInput))
    }
    
    func test_partII_extractCalibrationValue_multipleRows_shouldExtractSumOfNumbers() {
        let sampleData = """
            two1nine
            eightwothree
            abcone2threexyz
            ...
            7pqrstsixteen
            """
        XCTAssertEqual(281, extractCalibrationValuev2(sampleData))
    }
